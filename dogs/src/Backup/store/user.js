...
// renomeando o resetState para resetUserState
// é utilizado os : dentro da desestruturação
...
export const autoLogin = () => async (dispatch, getState) => {
  // existe o  estado token e dentro do token tem o data e dentro do
  // data tem o token novamente
